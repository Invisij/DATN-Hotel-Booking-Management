...
@section('title', 'Chọn Phòng Đặt Trước')
@section('head')
            ...
            <div class="col-md-8 mt-2">
                <div class="card shadow-sm border">
                    <div class="card-body p-3">
                        <h2>Còn {{ $roomsCount }} phòng trống cho:</h2>
                        <p>{{ request()->input('count_person') }} người từ
                            {{ Helper::dateFormat(request()->input('check_in')) }} đến
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-select" id="sort_name" name="sort_name"
                                        ...
                                        <option value="Price" @if (request()->input('sort_name') == 'Price') selected @endif>Giá
                                        </option>
                                        <option value="Number" @if (request()->input('sort_name') == 'Number') selected @endif>Số phòng
                                        </option>
                                        <option value="Capacity" @if (request()->input('sort_name') == 'Capacity') selected @endif>Sức chứa
                                        </option>
                                    </select>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-2">
                                    <button type="submit" class="btn myBtn shadow-sm border w-100">Tìm Kiếm</button>
                                </div>
                            </div>
                        </form>
                        <div class="row">
                            ...
                            @empty
                                <h3>Không có phòng trống cho {{ request()->input('count_person') }} người hoặc nhiều hơn
                                </h3>
                            @endforelse
                        </div>
                        <div class="row">
