...
@section('title', 'Chọn Ngày Đặt Phòng')
@section('head')
                ...
                <div class="card shadow-sm border">
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <label for="room_number" class="col-sm-2 col-form-label">Phòng</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="room_type" class="col-sm-2 col-form-label">Loại</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="room_capacity" class="col-sm-2 col-form-label">Sức chứa</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="room_price" class="col-sm-2 col-form-label">Giá / Ngày</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-sm-12 mt-2">
                                <form method="POST"
                                    ...
                                    <div class="row mb-3">
                                        <label for="how_long" class="col-sm-2 col-form-label">Tổng số ngày</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="how_long" name="how_long"
                                                placeholder="col-form-label" value="{{ $dayDifference }} Ngày" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="minimum_dp" class="col-sm-2 col-form-label">Đặt cọc tối thiểu</label>
                                        <div class="col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-primary float-end">Thanh toán đặt cọc</button>
                                </form>
                            </div>
                        </div>
                    </div>
