                                ...
                                @forelse (auth()->user()->unreadNotifications as $notification)
                                    <li>
                                        <p>
                                            ...
                                            <a href="{{ route('notification.routeTo', ['id' => $notification->id]) }}">tại
                                                đây</a>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <a href="{{ route('notification.markAllAsRead') }}"
                                            class="float-start mb-2 ms-2">Đánh dấu đã đọc</a>
                                        <a href="{{ route('notification.index') }}" class="float-end mb-2 me-2">Xem tất
                                            cả</a>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    ...
                    @if (auth()->user()->role == 'Admin')
                        <li><a class="dropdown-item" href="{{ route('activity-log.index') }}">Hoạt động</a></li>
                    @endif
                    <li>
