    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row">
                                    ...
                                    <div class="dropdown ms-auto mt-2" style="">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('customer.show', ['customer' => $customer->id]) }}">Chi
                                                    tiết</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                            ...
                                            <li>
                                                <form method="POST" id="delete-customer-form-{{ $customer->id }}"
                                                    ...
                                                    <a class="dropdown-item delete" href="#"
                                                        customer-id="{{ $customer->id }}" customer-role="Khách hàng"
                ...
                @empty
                    <p class="text-center">Không tìm thấy khách hàng nào trong cơ sở dữ liệu</p>
                @endforelse
            </div>
    ...
    <script>
        $('.delete').click(function() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                text: customer_name + " sẽ bị xóa, bạn không thể hoàn tác điều này!",
                icon: 'warning',
