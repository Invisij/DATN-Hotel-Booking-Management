    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="p-3 text-center">
                Phòng có người ở {{ Helper::dateFormat($date) }}
            </h3>
        </div>
    </div>
    <div class="row">
                ...
                <div
                    ...
                    <div class="col d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2 text-primary">
                            <a class="bg-dark p-3 text-center align-middle text-white"
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img width="200" height="250" src="{{ $transaction->customer->user->getAvatar() }}"
                            alt="">
                    </div>
                </div>
            </div>
